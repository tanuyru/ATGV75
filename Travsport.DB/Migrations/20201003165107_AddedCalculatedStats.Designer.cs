...
namespace Travsport.DB.Migrations
{
    ...
    [Migration("20201003165107_AddedCalculatedStats")]
    partial class AddedCalculatedStats
    {
            ...
            modelBuilder.Entity("Travsport.DB.Entities.RaceResult", b =>
                {
                    ...
                    b.HasIndex("HorseStatsId")
                        .IsUnique()
                        .HasFilter("[HorseStatsId] IS NOT NULL");
            ...
            modelBuilder.Entity("Travsport.DB.Entities.RaceResult", b =>
                {
                    ...
                    b.HasOne("Travsport.DB.Entities.HorseStats", "HorseStats")
                        .WithOne("RaceResult")
                        .HasForeignKey("Travsport.DB.Entities.RaceResult", "HorseStatsId");
